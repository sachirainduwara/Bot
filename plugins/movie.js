// ==========================================
//  SACHIYA MD 💫 - MOVIE DOWNLOAD PLUGIN
// ==========================================
...
cmd({
  ...
  msg += `*🔗 Fetching download links, please wait a moment...* ⏳\n\n`;
  msg += `> *© SACHIYA MD 💫*`;
  ...
  if (!downloadLinks.length) return reply(`*❌ No download links found under 2GB limit!* \n\n> *© SACHIYA MD 💫*`);
...
cmd({
  ...
  reply(`*⬇️ Preparing and Uploading ${selectedLink.quality} movie document...*\n*⏳ Please be patient, this may take a little time.*\n\n> *✨ SACHIYA MD 💫 UPLOADER*`);
  ...
  try {
    ...
    await danuwa.sendMessage(from, {
      ...
      caption: `*╭──────────────────╮*\n│  🎬 *SACHIYA MD MOVIE* 🎬\n*╰──────────────────╯*\n\n✨ *Title:* ${movie.metadata.title}\n📊 *Quality:* ${selectedLink.quality}\n💾 *Size:* ${selectedLink.size}\n\n*🍿 Enjoy your movie! Don't forget to share!* \n\n> *© Powered by SACHIYA MD 💫*`
    }, { quoted: mek });
  } catch (error) {
