...
*Powered by SACHIYA-MD 💫*`;
        ...
        await sachiya.sendMessage(from, {
            audio: { url: 'https://github.com/sachirainduwara/Bot/blob/main/Media/Welcome%20To%20SACHIYA%20MD.mp3' },
            mimetype: 'audio/mpeg',
            ptt: true
        }, { quoted: mek });
        ...
        await sachiya.sendMessage(from, {
            image: { url: 'https://github.com/sachirainduwara/Bot/blob/main/Media/SACHIYA%20MD.png' },
            caption: aliveMsg
        }, { quoted: mek });
